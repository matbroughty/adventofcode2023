...
class MapMovementCalculatorTest {
    ...
    public void init() {
        ...
        Reader inputString = new StringReader(EXAMPLE_MAP_DATA);
    ...
    @Test
    public void testMapMovementExampleData() {
        assertEquals(6, mapMovementCalculator.mapMoveCount());
    }
    ...
    public void testActualDataPartOne() {
        ...
        mapMovementCalculator = new MapMovementCalculator(fileUrl);
        mapMovementCalculator.setFileLines(reader.lines().toList());
        assertEquals(17141, mapMovementCalculator.mapMoveCount());
    }
    ...
    @Test
    public void testReadMoves() {
        ArrayDeque<String> moves = mapMovementCalculator.readMoves();
        assertEquals(3, moves.size());
        assertEquals("L", moves.getFirst());
        assertEquals("R", moves.getLast());
    }

    @Test
    public void testLoadMap() {
        Map<String, Pair<String, String>> map = mapMovementCalculator.loadMap();
        assertEquals(3, map.size());
        assertEquals("AAA", map.get("BBB").getLeft());
        assertEquals("ZZZ", map.get("BBB").getRight());
    }
}