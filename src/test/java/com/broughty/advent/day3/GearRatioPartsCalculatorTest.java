...
public class GearRatioPartsCalculatorTest {


    private final static String exampleEngineSchematic =
            """
                    467..114..
                    ...*......
                    ..35..633.
    ...
    private final static String exampleEngineSchematic2 =
            """
                    467..114..
                    ...*......
                    ..35..633.
    ...
    private final static String fileSnippet =
            """
    ...
    @Value("${advent.day3File}")
    String fileUrl;
    @Value("${advent.cookie}")
    String cookie;

    @Test
    public void testExampleEngineSchematic() {

        Reader inputString = new StringReader(exampleEngineSchematic);
        BufferedReader reader = new BufferedReader(inputString);
        List<String> lines = reader.lines().toList();

        GearRatioPartsCalculator gearRatioPartsCalculator = new GearRatioPartsCalculator(fileUrl);
        gearRatioPartsCalculator.setFileLines(lines);
        assertEquals(4361, gearRatioPartsCalculator.calculateSparePartsNumber());


    }

    @Test
    public void testExampleEngineSchematicTwo() {

        Reader inputString = new StringReader(exampleEngineSchematic2);
        BufferedReader reader = new BufferedReader(inputString);
        List<String> lines = reader.lines().toList();

        GearRatioPartsCalculator gearRatioPartsCalculator = new GearRatioPartsCalculator(fileUrl);
        gearRatioPartsCalculator.setFileLines(lines);
        assertEquals(4362, gearRatioPartsCalculator.calculateSparePartsNumber());


    }

    @Test
    public void testExampleEngineSchematicFileSnippet() {

        Reader inputString = new StringReader(fileSnippet);
        BufferedReader reader = new BufferedReader(inputString);
        List<String> lines = reader.lines().toList();

        GearRatioPartsCalculator gearRatioPartsCalculator = new GearRatioPartsCalculator(fileUrl);
        gearRatioPartsCalculator.setFileLines(lines);
        assertEquals(551258, gearRatioPartsCalculator.calculateSparePartsNumber());


    }

    @Test
    public void testFullEngineSchematic() {


        GearRatioPartsCalculator gearRatioPartsCalculator = new GearRatioPartsCalculator(fileUrl);
        gearRatioPartsCalculator.setCookie(cookie);
        gearRatioPartsCalculator.readFileLines();
